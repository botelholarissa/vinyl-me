...
def get_data(pageNo,q):  
    ...
    #Jazz Category
    r = requests.get("https://www.amazon.com.br/s?i=popular&bbn=19549018011&rh=n%3A7791937011%2Cn%3A7791942011%2Cn%3A7791944011%2Cn%3A19549018011%2Cn%3A19416074011&dc&page="+str(pageNo), headers=headers)#, proxies=proxies)
    content = r.content
    ...
    for d in soup.findAll('div', attrs={'class':'sg-col-4-of-12 sg-col-8-of-16 sg-col-16-of-24 sg-col-12-of-20 sg-col-24-of-32 sg-col sg-col-28-of-36 sg-col-20-of-28'}):
        ...
        if author == 'por' or author is None:
            all.append('unknown-author')
        else:
            all.append(author.text)
...
if __name__ == "__main__":
    ...
    print(df)
    df.to_csv('./categories/blues/blues_'+ strnow +'.csv', index=False, encoding='utf-8')