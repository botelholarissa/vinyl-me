...
def get_data(pageNo,q):  
    ...
    #Jazz Category
    r = requests.get("https://www.amazon.com.br/s?i=popular&bbn=19549018011&rh=n%3A7791937011%2Cn%3A7791942011%2Cn%3A7791944011%2Cn%3A19549018011%2Cn%3A19416081011&dc&page="+str(pageNo), headers=headers)#, proxies=proxies)    content = r.content
    content = r.content
...
if __name__ == "__main__":
    ...
    print(df)
    df.to_csv('./metal_'+ strnow +'.csv', index=False, encoding='utf-8')